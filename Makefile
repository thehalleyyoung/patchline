.PHONY: build test demo gate fmt public-corpus verify-usefulness artifact-smoke artifact-demo artifact-ground-truth-check artifact-baselines artifact-ablations artifact-scale artifact-studies artifact-benchmark artifact-benchmark-public artifact-benchmark-refresh artifact-benchmark-compare artifact-negative-cases artifact-full artifact-clean
...
artifact-full: artifact-smoke artifact-demo artifact-studies artifact-benchmark-compare artifact-negative-cases verify-usefulness
