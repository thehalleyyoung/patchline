...
func DefaultContract() Contract {
	contract := Contract{
		...
		ArtifactKinds: []ArtifactKind{
			...
			{"incident_archive", []string{"facts", "hashes"}, []string{"archive-index"}, "searchable historical incident index grouped by evidence shape, migration semantics, repair effect, policy decision, and benchmark result"},
