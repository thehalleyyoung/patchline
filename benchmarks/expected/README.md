...
Generated benchmark reports are written to `results/generated/artifact-benchmark/`; the committed benchmark JSON files here are the golden comparison targets for the smoke, negative, repair, semantic-regression, pinned public migration, offline public incident, public-derived repair, and public-derived archive manifests.
