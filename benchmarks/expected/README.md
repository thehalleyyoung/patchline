...
Generated benchmark reports are written to `results/generated/artifact-benchmark/`; the committed benchmark JSON files here are the golden comparison targets for the smoke, negative, pinned public migration, and offline public incident manifests.
