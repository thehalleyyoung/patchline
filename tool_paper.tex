...
conditional replication-lag analysis, and partition/shard routing semantics
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  versioned database semantics, online-schema-change adapters, partition/shard routing semantics, and lock-mode conflict simulations
...
profiles and attaches statement-level rules for transactional DDL, implicit commits, atomic DDL,
...
Database engine semantics & \code{db\_semantics}, \code{engine\_profile}, \code{lock\_simulation}, \code{online\_schema\_change}, \code{replication\_lag\_risk}, \code{partition\_sharding} & 8-engine versioned fixture + lock-mode simulator + online-schema-change adapter gate + replication-lag risk gate + partition/sharding semantics gate + unsupported-engine negative control \\
