...
conditional replication-lag analysis, query-plan regression preflight, partition/shard routing semantics, and rollback-feasibility verdicts
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  versioned database semantics, online-schema-change adapters, query-plan regression preflight, partition/shard routing semantics, rollback feasibility, and lock-mode conflict simulations
...
tenant routing, partition swaps, shard rebalancing,
...
Database engine semantics & \code{db\_semantics}, \code{engine\_profile}, \code{lock\_simulation}, \code{online\_schema\_change}, \code{replication\_lag\_risk}, \code{partition\_sharding}, \code{rollback\_feasibility} & 8-engine versioned fixture + lock-mode simulator + online-schema-change adapter gate + replication-lag risk gate + partition/sharding semantics gate + rollback-feasibility gate + unsupported-engine negative control \\
