...
capability against real, pinned public code and fails loudly on drift. \tool{} currently ships 209
such gates over 166 documented capabilities, spanning relational migrations across nine ecosystems,
five NoSQL engines, four data-pipeline frameworks, protobuf/Avro schema compatibility,
infrastructure/data ordering, and a research-grade evaluation methodology that includes blinded
false-positive adjudication, seeded false-negative recall, ablations, standardized effect sizes, and
severity calibration against independent danger evidence. We describe \tool's design principles,
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---209 gates, blinded
...
currently ships \textbf{209 gates}, \textbf{166 capability documents}, and \textbf{142 example
...
209 gates / 166 docs / 142 examples & repository inventory \\
\bottomrule
\end{tabular}
\end{table}
...
\tool{} ships 209 gates; Table~\ref{tab:gatecatalog} lists a representative selection grouped by
...
\bottomrule
\caption{A representative selection from the 209-gate catalog, grouped by theme.}
