...
surface now also derives invariant-backed expand/contract templates, then uses a staged backfill
planner to gate constraint-tightening and compatibility-code deletion on an exhaustive replay-store
proof. Critically,
