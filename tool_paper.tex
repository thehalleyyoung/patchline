...
cite evidence and reproducing gates before comparing trained reviewers with controls, while a
...
than 619 such gates over 564 documented capabilities, spanning relational migrations across nine
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---over 617 gates, blinded
