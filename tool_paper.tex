...
surface now also derives invariant-backed expand/contract templates and checks Rails, Django, and
Prisma evidence before a contract step is trusted. Critically,
...
production-grade remediation loops for backfill, rollback, repair escrow, playbooks, and patch-series safety; a
