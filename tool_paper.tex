...
artifact hashes, explicit consent, and reproducible commands.
Critically,
...
\code{evidence-marketplace} & Publish redacted public hazard examples only after clear-license,
consent, symlink-safe artifact-hash, certificate-obligation, and public-data reproduction checks pass. &
\code{marketplace.json}, \code{marketplace.md}, \code{index.html} \\
...
artifact, obligation, license, and reproduction metadata. The
\gate{evidence-marketplace-gate} publishes two redacted public-corpus examples and then corrupts a
copied certificate hash; the bad marketplace must be rejected while the tracked fixture remains
untouched.
...
2 redacted, certificate-backed public evidence examples; corrupted certificate rejected & \gate{evidence-marketplace-gate} \\
