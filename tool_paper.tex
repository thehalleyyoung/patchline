...
dependency-depth, fanout, wave, and data-loss bounds, and a remediation-cost optimizer chooses guard,
backfill, expand/contract, or manual review using uncertainty-adjusted expected loss.
Critically,
