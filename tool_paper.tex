...
private adopters can then run federated benchmark splits locally and publish only signed,
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  severity calibration, a duplicate-safe certificate-backed public evidence marketplace, and signed
  federated benchmark aggregates for private adopters---designed for artifact
