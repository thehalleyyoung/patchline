...
ecosystems, versioned database semantics, lock-mode simulations, and online-schema-change adapters
...
concurrent or online index behavior, online-schema-change adapters, instant or metadata-only column addition, \code{CREATE OR REPLACE}
...
Database engine semantics & \code{db\_semantics}, \code{engine\_profile}, \code{lock\_simulation}, \code{online\_schema\_change} & 8-engine versioned fixture + lock-mode simulator + online-schema-change adapter gate + unsupported-engine negative control \\
...
externally adopted governance; deeper lock, replication, partitioning, rollback, online-schema-change,
and query-plan semantics on top of the new versioned production-database profiles;
