...
and ecosystems using hashed review evidence;
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---over 612 gates, blinded
  ...
  governance-board lifecycle decisions, hash-bound appeal resolution, reviewer-fairness burden/false-positive/escalation audits, adversarial-challenge scoring, signed federated benchmark
...
socio-technical accountability beyond the new accountable-use mapping, including fairness,
ethics, and detector deprecation; education and
...
\emph{every} such claim can be made reproducible: over 610 gates prove the system against real, pinned
