...
emergency expiry rather than bypassing the safety layer, and an incident-response drill rehearses
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  governance-board lifecycle decisions, hash-bound appeal resolution, reviewer-fairness burden/false-positive/escalation audits, change-management approval binding, adversarial-challenge scoring, signed federated benchmark
...
socio-technical accountability beyond accountable-use, reviewer-fairness, and change-management binding,
including ethics and detector deprecation; education and
...
\code{change-management-integration-gate}, \code{incident-response-drill-gate} \\
