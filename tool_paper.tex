...
capability against real, pinned public code and fails loudly on drift. \tool{} currently ships 159
such gates over 116 documented capabilities, spanning relational migrations across nine ecosystems,
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---159 gates, blinded
...
currently ships \textbf{159 gates}, \textbf{116 capability documents}, and \textbf{92 example
...
\emph{every} such claim can be made reproducible: 159 gates prove the system against real, pinned
...
\tool{} ships 159 gates; Table~\ref{tab:gatecatalog} lists a representative selection grouped by
...
\bottomrule
\caption{A representative selection from the 159-gate catalog, grouped by theme.}
