...
and an incident-response drill rehearses
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  governance-board lifecycle decisions, hash-bound appeal resolution, reviewer-fairness burden/false-positive/escalation audits, change-management approval binding, governance-risk concentration audits, ethics-review controls for data sources, live learning, and outcome studies, independent explainability audits for stated verdicts, adversarial-challenge scoring, signed federated benchmark
...
\code{ethics-review-template-gate}, \code{explainability-audit-gate}, \code{incident-response-drill-gate} \\
