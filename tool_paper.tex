...
quorum, conflict checks, hash binding, and archive-preserving tombstones, and an appeal workflow resolves
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---over 611 gates, blinded
  ...
  governance-board lifecycle decisions, hash-bound appeal resolution, adversarial-challenge scoring, signed federated benchmark
