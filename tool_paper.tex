...
quorum, conflict checks, hash binding, and archive-preserving tombstones;
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  governance-board lifecycle decisions, adversarial-challenge scoring, signed federated benchmark
...
externally adopted governance; deeper rollback, query-plan, data-volume, and engine-negative-control semantics
on top of the new versioned production-database profiles;
socio-technical accountability beyond the new accountable-use mapping, including appeals, fairness,
...
\code{evidence-governance-board-gate} \\
