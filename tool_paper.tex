...
snapshots and emits only hash-based counterexamples. Critically,
...
\code{staged-backfill-planner-gate}, \code{canary-validation-gate}, \code{reviewability-examples-gate} \\
