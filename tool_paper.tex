...
explicit rubric over real evidence hashes, while a change-management verifier proves organizational
...
than 615 such gates over 560 documented capabilities, spanning relational migrations across nine
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---over 615 gates, blinded
