...
ecosystems, versioned database semantics across eight production engines, five NoSQL engines,
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  versioned database semantics (eight engines), NoSQL changes (five engines), data pipelines
...
SQL on ClickHouse while actually launching background mutations. The new
...
Database engine semantics & \code{db\_semantics}, \code{engine\_profile} & 8-engine versioned fixture + unsupported-engine negative control \\
