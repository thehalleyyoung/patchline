...
conditional replication-lag analysis, partition/shard routing semantics, and rollback-feasibility verdicts
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  versioned database semantics, online-schema-change adapters, partition/shard routing semantics, rollback feasibility, and lock-mode conflict simulations
