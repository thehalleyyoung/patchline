...
than 400 such gates over 360 documented capabilities, spanning relational migrations across nine
...
and a reproducibility appendix) that each ship as their own falsifiable gate. The most recent
hundred gates push the methodology further still---toward mechanized formal foundations, ecosystem-scale
mining, a definitive causal/field evaluation design, product-grade adoption surfaces, a learned-but-verified
research frontier, and a lasting-impact dossier---each, again, expressed as a falsifiable gate with a
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item A \textbf{gate-backed reproducibility and evaluation methodology}---over 400 gates, blinded
...
currently ships \textbf{410 gates}, \textbf{366 capability documents}, and \textbf{342 example
...
300+ gates / 260+ docs / 300+ examples & repository inventory \\
\bottomrule
\end{tabular}
\end{table}
...
\emph{every} such claim can be made reproducible: 209 gates prove the system against real, pinned
...
\tool{} ships more than 400 gates; Table~\ref{tab:gatecatalog} lists a representative selection grouped by
...
\bottomrule
\caption{A representative selection from the 400+-gate catalog, grouped by theme.}
