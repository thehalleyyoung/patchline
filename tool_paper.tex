...
ecosystems, versioned database semantics and lock-mode simulations across eight production engines, five NoSQL engines,
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  versioned database semantics and lock-mode conflict simulations (eight engines), NoSQL changes (five engines), data pipelines
...
concurrent or online index behavior, instant or metadata-only column addition, \code{CREATE OR REPLACE}
...
Database engine semantics & \code{db\_semantics}, \code{engine\_profile}, \code{lock\_simulation} & 8-engine versioned fixture + lock-mode simulator + unsupported-engine negative control \\
