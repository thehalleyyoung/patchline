...
than 300 such gates over 260 documented capabilities, spanning relational migrations across nine
...
and a reproducibility appendix) that each ship as their own falsifiable gate. We describe \tool's design principles,
...
\tool{} ships more than 300 gates; Table~\ref{tab:gatecatalog} lists a representative selection grouped by
...
\bottomrule
\caption{A representative selection from the 300+-gate catalog, grouped by theme.}
