...
preregistration, and hashed evidence, and an incident-response drill rehearses
...
than 614 such gates over 560 documented capabilities, spanning relational migrations across nine
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  governance-board lifecycle decisions, hash-bound appeal resolution, reviewer-fairness burden/false-positive/escalation audits, change-management approval binding, governance-risk concentration audits, ethics-review controls for data sources, live learning, and outcome studies, adversarial-challenge scoring, signed federated benchmark
...
governance-risk registration, and ethics review, especially detector deprecation; education and
...
\emph{every} such claim can be made reproducible: over 614 gates prove the system against real, pinned
...
\code{ethics-review-template-gate}, \code{incident-response-drill-gate} \\
