...
and conditional replication-lag analysis
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  versioned database semantics, online-schema-change adapters, and lock-mode conflict simulations
...
Database engine semantics & \code{db\_semantics}, \code{engine\_profile}, \code{lock\_simulation}, \code{online\_schema\_change}, \code{replication\_lag\_risk} & 8-engine versioned fixture + lock-mode simulator + online-schema-change adapter gate + replication-lag risk gate + unsupported-engine negative control \\
...
externally adopted governance; deeper partitioning, rollback, query-plan, and data-volume semantics
